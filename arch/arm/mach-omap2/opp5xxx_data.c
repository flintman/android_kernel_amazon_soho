...
static struct omap_opp_def omap543x_opp_def_list[] = {
	/* MPU OPP1 - OPPLOW */
	OPP_INITIALIZER(&mpu_dev_info, true, 499200000,
			OMAP54XX_VDD_MPU_OPP_LOW, "OPPLOW"),
	/* MPU OPP2 - OPPNOM: */
	OPP_INITIALIZER(&mpu_dev_info, true, 1000000000,
			OMAP54XX_VDD_MPU_OPP_NOM, "OPPNOM"),
	/* MPU OPP3 - OPP-HIGH */
	OPP_INITIALIZER(&mpu_dev_info, true, 1500000000,
			OMAP54XX_VDD_MPU_OPP_HIGH, "OPPHIGH"),
	/* MPU OPP4 - OPP-SPEEDBIN */
	OPP_INITIALIZER(&mpu_dev_info, false, 1699200000,
			OMAP54XX_VDD_MPU_OPP_SB, "OPPSPEEDBIN"),

	/* L3 OPP2 - OPPNOM */
	OPP_INITIALIZER(&l3_dev_info, true, 265920000,
			OMAP54XX_VDD_CORE_OPP_NOM, "OPPNOM"),
	...
	OPP_INITIALIZER(&ipu_dev_info, true, 425500000,
			OMAP54XX_VDD_CORE_OPP_NOM, "OPPNOM"),

	/* CORE_ISS_MAIN_CLK OPP2 - OPPNOM */
	OPP_INITIALIZER(&iss_dev_info, true, 303900000,
			OMAP54XX_VDD_CORE_OPP_NOM, "OPPNOM"),

	/* FDIF OPP2 - OPPNOM */
	OPP_INITIALIZER(&fdif_dev_info, true, 256000000,
			OMAP54XX_VDD_CORE_OPP_NOM, "OPPNOM"),
	...
	/* IVA OPP1 - OPPLOW */
	OPP_INITIALIZER(&iva_dev_info, true, 194100000,
			OMAP54XX_VDD_MM_OPP_LOW, "OPPLOW"),
	/* IVA OPP2 - OPPNOM */
	OPP_INITIALIZER(&iva_dev_info, true, 388300000,
			OMAP54XX_VDD_MM_OPP_NOM, "OPPNOM"),
	/* IVA OPP3 - OPP-OD */
	OPP_INITIALIZER(&iva_dev_info, true, 531200000,
			OMAP54XX_VDD_MM_OPP_OD, "OPPOD"),

	/* DSP OPP1 - OPPLOW */
	OPP_INITIALIZER(&dsp_dev_info, true, 233000000,
			OMAP54XX_VDD_MM_OPP_LOW, "OPPLOW"),
	/* DSP OPP2 - OPPNOM */
	OPP_INITIALIZER(&dsp_dev_info, true, 466000000,
			OMAP54XX_VDD_MM_OPP_NOM, "OPPNOM"),
	/* DSP OPP3 - OPP-OD */
	OPP_INITIALIZER(&dsp_dev_info, true, 531200000,
			OMAP54XX_VDD_MM_OPP_OD, "OPPOD"),

	/* NOTE ON SGX OPP: Configuration 1 - From CORE DPLL */
	/* SGX OPP1 - OPPLOW */
	OPP_INITIALIZER(&gpu_dev_info, true, 212700000,
			OMAP54XX_VDD_MM_OPP_LOW, "OPPLOW"),
	/* SGX OPP2 - OPPNOM */
	OPP_INITIALIZER(&gpu_dev_info, true, 425470000,
			OMAP54XX_VDD_MM_OPP_NOM, "OPPNOM"),
	/* SGX OPP3 - OPP-OD */
	OPP_INITIALIZER(&gpu_dev_info, true, 531840000,
			OMAP54XX_VDD_MM_OPP_OD, "OPPOD"),
};
